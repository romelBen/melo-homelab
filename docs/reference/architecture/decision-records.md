...
[Original proposal from @Bourne-ID](https://github.com/romelben/homelab/issues/70):
...
- CentOS/Rocky Linux (moved to Fedora in `022b816`):
    - Pros: relatively stable (however we did encounter a breaking change [#63](https://github.com/romelben/homelab/issues/63), still not sure why)
